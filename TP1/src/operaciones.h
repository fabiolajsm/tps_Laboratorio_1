 ...
 * @param pAfc Dirección de memoria donde se va a guardar el porcentaje de jugadores de esa confederación.
 * @param pCaf Dirección de memoria donde se va a guardar el porcentaje de jugadores de esa confederación.
 * @param pConcacaf Dirección de memoria donde se va a guardar el porcentaje de jugadores de esa confederación.
 * @param pConmebol Dirección de memoria donde se va a guardar el porcentaje de jugadores de esa confederación.
 * @param pUefa Dirección de memoria donde se va a guardar el porcentaje de jugadores de esa confederación.
 * @param pOfc Dirección de memoria donde se va a guardar el porcentaje de jugadores de esa confederación.
 ...
 * @param pAfc El porcentaje de jugadores de esa confederación.
 * @param pCaf El porcentaje de jugadores de esa confederación.
 * @param pConcacaf El porcentaje de jugadores de esa confederación.
 * @param pConmebol El porcentaje de jugadores de esa confederación.
 * @param pUefa El porcentaje de jugadores de esa confederación.
 * @param pOfc El porcentaje de jugadores de esa confederación.
